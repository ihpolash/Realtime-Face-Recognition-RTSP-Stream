...
# declare the image directory where all the faces stored with name
face_dir = sys.argv[1]
...
while True:
    ...
    for (top, right, bottom, left), name in zip(face_locations, face_names):
        ...
        # cv2.putText(img=frame, text=str(len(faces)),org=(x + int(w/10),y + int(h/1.5)), fontFace=cv2.FONT_HERSHEY_DUPLEX, fontScale=4, color=(255,0,0), thickness=7)
